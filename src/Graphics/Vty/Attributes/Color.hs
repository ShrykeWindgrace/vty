...
-- I know that my terminal has support for FullColor
-- I do not quite know how to handle ColorMode240
-- and that does not seem like a priority right now
detectColorMode :: String -> IO ColorMode
detectColorMode _ = pure FullColor
